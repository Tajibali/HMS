        ...
        <div className="bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur-md">
          ...
          <form onSubmit={handleAddPatient} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-bold rounded-xl disabled:opacity-50 mt-6"
            >
        ...
        <div className="bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur-md">
          ...
          <form onSubmit={handleAddDoctor} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-bold rounded-xl disabled:opacity-50 mt-6"
            >
        ...
        <div className="bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur-md">
          ...
          <form onSubmit={handleCreateAppointment} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-bold rounded-xl disabled:opacity-50 mt-6"
            >
