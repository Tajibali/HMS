                    ...
                    <div className="space-y-2">
                        ...
                        {isAdmin ? (
                            <>
                                ...
                                <Link href="/dashboard/patients" className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 text-sm font-medium text-purple-300 transition-all">
                                    <span>👤</span> Patients
                                </Link>
                                <Link href="/dashboard/doctors" className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 text-sm font-medium text-emerald-300 transition-all">
                                    <span>🩺</span> Doctors
                                </Link>
                            </>
                        ) : (
